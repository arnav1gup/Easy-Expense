//
//  LastYearAnalysisContainerViewController.swift
...
class LastYearAnalysisContainerViewController: UIViewController,UITableViewDelegate,UITableViewDataSource {
    var currentYear1:Date = Date()
